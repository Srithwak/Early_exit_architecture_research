...
class Pipeline:
    ...
    def save(self):
        ...
        out = {"dataset": "MIT-BIH Arrhythmia", "config": vars(self.cfg), "results_summary": self.results,
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Early Exit Research — MIT-BIH")
